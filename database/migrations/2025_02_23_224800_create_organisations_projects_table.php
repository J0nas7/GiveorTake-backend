...
class CreateProjectManagementTables extends Migration
{
    public function up()
    {
        ...
        Schema::create('GT_Team_Members', function (Blueprint $table) {
            $prefix = 'Team_Member_';

            $table->bigIncrements($prefix . 'ID'); // Primary key
            $table->bigInteger('Team_ID')->unsigned(); // Foreign key to Teams
            $table->bigInteger('User_ID')->unsigned(); // Foreign key to Users
            $table->enum($prefix . 'Role', ['Lead', 'Member'])->default('Member'); // Role in team
        ...
        // Project Teams table (linking teams to projects)
        Schema::create('GT_Project_Teams', function (Blueprint $table) {
            $prefix = 'Project_Team_';
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('GT_Project_Teams');
        Schema::dropIfExists('GT_Team_Members');
